export const ja = {
    ...
    form: {
        ...
        dynamicDcaTooltip: '相対力指数（RSI）に基づいて週次予算を調整します。\n- 低RSI (<30): 市場は売られ過ぎ、多めに購入。\n- 高RSI (>70): 市場は買われ過ぎ、少なめに購入。',
        rsiTierLabel: 'RSI階層',
        ...
        valueAveragingTooltip: 'ポートフォリオ価値が各期間一定額増加することを目指します。\n- 価値が目標を下回る場合、差額を購入。\n- 価値が目標を上回る場合、差額を売却（または何もしない）。',
        periodGrowth: '目標期間成長額 ($)',
        maxBuyCap: '最大購入キャップ ($)',
        maxSellCap: '最大売却キャップ ($)',
        selectAsset: '資産を選択',
