export const en = {
    ...
    form: {
        ...
        valueAveragingTooltip: 'Aims for the portfolio value to increase by a set amount each period. <br/> - If value is below target, buy the difference. <br/> - If value is above target, sell the difference (or do nothing).',
