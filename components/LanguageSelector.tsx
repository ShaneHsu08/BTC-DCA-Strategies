    ...
    return (
        <div className="relative">
            <select
                ...
                className="appearance-none bg-background border border-border rounded-md py-2 pl-3 pr-8 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-ring"
